...
/// @nodoc
mixin _$Board {
  List<Player> get cells => throw _privateConstructorUsedError;
...
class _$BoardImpl extends _Board {
  const _$BoardImpl({required final List<Player> cells})
    : _cells = cells,
      super._();
...
abstract class _Board extends Board {
  const factory _Board({required final List<Player> cells}) = _$BoardImpl;
